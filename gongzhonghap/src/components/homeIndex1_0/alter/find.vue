<template>
  <!--发现-->
<div id="box" class="clearfix" ref="box"  @scroll="boxScroll" >
  <ul class="left"></ul>
  <ul class="right"></ul>
  <ul class="list fl" v-show="false">
    <li v-for="item in data" @click="clickFn(item)">
      <!--<img :src=item.imageUrl1 alt="":style="'height:'+item.cover.height/(item.cover.width/185)/100+'rem'"/>-->
      <img class="img" :src=item.imageUrl1 alt=""/>

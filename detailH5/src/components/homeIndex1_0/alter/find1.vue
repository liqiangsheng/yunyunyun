<template>
  ...
  <div id="find">
    <div class="find_box" ref="findBox">
      <vue-waterfall-easy ref="waterfall" :imgsArr="imgsArr" srcKey="imageUrl1" @click="clickFn" :maxCols="maxCols" :mobileGap="mobileGap" @scrollReachBottom="getData">

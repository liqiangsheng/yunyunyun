        ...
        <el-popover ref="popover" placement="bottom-end" width="500" v-model="visible">
            ...
            <div class="popoverBox">
                ...
                <el-checkbox-group v-model="checkedOps" @change="handleCheckedCitiesChange" >
                    <el-checkbox v-for="label in formDataLabel" :label="label" :key="label">{{label}}</el-checkbox>
                </el-checkbox-group>
            </div>
...
<script>
    ...
    export default {
        name: 'popover',
        props: ["formDataLabel","tableKey","tableShow","pageName"],
        data(){
            return{
                visible:false,
                ...
                checkAll:true,
                checkedOps: [], //选中值
                formDataLabelData:this.formDataLabel,
        ...
        methods:{
            ...
            popoverBtn(){      //显示字段确定按钮
                let _this =this;
                let a = new Set(this.formDataLabel);

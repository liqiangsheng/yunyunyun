    ...
    <div class="main-box">
        <div class="form-box input-box-center">
            <el-form :inline="true" :model="formData" ref="formData" class="demo-form-inline">
                ...
                <el-row :span="24">
                    <el-col :span="6">
                        <el-form-item label="商品名称：" label-width="30%"  prop="goodsName" :rules="filter_rules({required:true})">
                            <el-input v-model="formData.goodsName" placeholder="请输入商品名称" :maxlength="20"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="商品编码：" label-width="30%" prop="goodsCode" :rules="filter_rules({ required:true,type:'letterAndNumber'})">
                            <el-input v-model="formData.goodsCode" placeholder="请输入商品编码" :maxlength="20"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                    ...
                    <el-col :span="6">
                        <el-form-item label="代销合作商家：" label-width="120px" prop="agencySellerId" >
                    ...
                    <el-col :span="6">
                        <el-form-item label="基础商品单元：" label-width="30%" class="is-required">
                            <!--
                                selectOption 组件选中值 Array
                                optionData  组件数据源 Object
                            -->
            ...
            <div class="fromBox">
                <el-form :model="dialogData" ref="dialogData" label-width="35%" >
                    ...
                    <div style="text-align: center;margin-top: 10px;">
                        <el-button type="primary" size="small" @click.native="formTableVisibleFun()">取消</el-button>
                        <el-button type="primary" size="small" @click.native="saveBtn()"  class="btn-active">确定</el-button>
                    </div>
                </el-form>
            </div>
        </el-dialog>
        ...
        <el-dialog :append-to-body="true" class="dialog" title="选择附加商品单元"  :close-on-click-modal="true"
            ...
            <div class="fromBox">
                <el-form :model="dialogDataS" ref="dialogDataS" label-width="35%" >
                    ...
                    <el-form-item label-width="0%" class="itemBtn">
                        <el-button type="primary" size="small" @click="searchS(1)">搜索</el-button>
                        <el-button type="primary" size="small" @click="resetS('dialogDataS')" >重置</el-button>
                    </el-form-item>
                    <div>
                        <el-table
                    ...
                    <div style="text-align: center;margin-top: 10px;">
                        ...
                        <el-button type="primary" size="small" @click.native="saveBtnF()"  class="btn-active">确定</el-button>
                    </div>
                </el-form>
            </div>
        </el-dialog>
...
<script>
    import { certProjectSetController01,certProjectSetController02 , marketGoodsList ,commodityMgr03,saveGoodsOrUpdate,marketGoodsUnitList} from '@/api/marketing/commodityMgr';
    ...
    export default {
        ...
        data(){
            return{
                overdueStateShow:false,  //是否过期
                checkWayState:false, //核销方式
                //弹窗数据
                selectTable:[],
                additionalTable:[],
               ...
               // <!--goodsUnitName goodsCode price agencySellerId 1 2 disable checkWay verificationStage verificationNode overdueNodeStatus overdue validityPeriod-->
                ...
                addForm:{},
                value:'',
                marketGoodsUnitListData:[],
                selectOptionTableData:[],
            }
        },
        methods:{
            /*商品分类转换成中文*/
            ...
            verificationChange(val){
                this.formData.verificationNodeStatus = val.join(',')
            },
            reset(formName){
            ...
            search(pageNo){
                this.getDialogList(pageNo)
            },
            searchS(pageNo){
                this.getDialogListS(pageNo)
            },

            //基础
            getDialogList(pageNo){
            ...
            //获取数据源select-option-table
            getSelectOptionTable(){
            ...
            saveBtn(){ //基本商品单元
               if(this.selectTable !== null){
                   ...
                   this.formData.selectOption = [this.selectTable.id];

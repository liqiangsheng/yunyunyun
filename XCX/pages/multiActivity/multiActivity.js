      ...
      wx.request({
        ...
        success: (res => {
           if(res.data.status==true){
             ...
             if (that.data.arr.activityGoodsVoList && that.data.arr.activityGoodsVoList.length>0){
             ...
             if (that.data.arr.activityGoodsGroupVoList && that.data.arr.activityGoodsGroupVoList.length>0){

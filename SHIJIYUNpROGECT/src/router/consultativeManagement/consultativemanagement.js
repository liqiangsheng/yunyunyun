...
const consultativeManagement = [
    { path: 'consultativeManagement', component: _import('layout/routerView'), name: '咨讯管理菜单', children: [
        // 资讯管理子页面
        ...
        { path: 'Individual_audit', component: _import('consultativeManagement/Individual_audit'), name: '单项审核管理`' },

          ...
          <ul class="commentBox" v-for="(item,index) in objData">
              <li>
                  <div class="commentBoxList">
                      <div class="commentBoxLeft">文章</div>
                      <div class="commentBoxRight">
                          <el-table
                              ...
                              <el-table-column prop="yuduliang" label="阅读量" width="100"></el-table-column>
                              <el-table-column prop="dianzan" label="点赞" width="100"></el-table-column>
                              <el-table-column prop="pinlun"label="评论" width="100"> </el-table-column>
                              <el-table-column prop="zhuangtai" label="状态"width="100"></el-table-column>
                              ...
                              <el-table-column width="80" type="expand" >
                                  <template slot-scope="props">
                                      <el-form label-position="left" inline class="demo-table-expand">
                                          <el-form-item :label="props.row.pinglunNum" v-for="(item1,index1) in props.row.childres" class="childresList" :key="index1">
        ...
        data() {
            return {
                ...
                objData:[  //数据列表
                    {
                        tableData:[
                            {checked:false,title:"设计界的法拉利是如何产生的",type:"图文",yuduliang:"8005",dianzan:"2075",pinlun:"1088",zhuangtai:"已上架",time:1541584800000,shenhe:"系统"},
                            {checked:false,title:"设计界的法拉利是如何产生的",type:"图文",yuduliang:"8005",dianzan:"2075",pinlun:"1088",zhuangtai:"已上架",time:1541584800000,shenhe:"系统"},
                            {checked:false,title:"设计界的法拉利是如何产生的",type:"图文",yuduliang:"8005",dianzan:"2075",pinlun:"1088",zhuangtai:"已上架",time:1541584800000,shenhe:"系统"},
                            ],
                        comentList:[
